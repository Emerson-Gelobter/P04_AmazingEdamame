...
var getSales = function() {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        var median = inner[6];
        var highest = inner[7];
        input.push([year.toString(), name, typeDwelling, { v: salesAmt, f: salesAmt.toString() }, { v: lowest, f: lowest.toString() }, { v: average, f: "$" + average.toString()}, { v: median, f: "$" + median.toString()}, { v: highest, f: "$" + highest.toString()}]);
    }
    drawTable(input);
    };
